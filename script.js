...
function populateTable(){
     for(const flight of flights){
          ...
          const tableDefinition1 = document.createElement('td');
          tableDefinition1.textContent = '✈';
          tableRow.append(tableDefinition1);
          for(const flightDetail in flight){
               const tableDefinition2 = document.createElement('td');
               ...
               for(const [index,letter] of word.entries()){
                    ...
                    setTimeout(() => {
                         ...
                         tableDefinition2.append(div);
                    },100 * index);
               }
               tableRow.append(tableDefinition2);
          }
...
function generateRandomNumber(maximumNumber){
     ...
     if(maximumNumber){
          const newNumbers = numbers.slice(0,maximumNumber);
